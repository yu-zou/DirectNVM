...
set_property PACKAGE_PIN J16 [get_ports {disable_ssd2_pwr[0]}]
...
set_property PACKAGE_PIN AK13 [get_ports user_lnk_up_0]
set_property IOSTANDARD LVCMOS12 [get_ports user_lnk_up_0]

set_property PACKAGE_PIN AM8 [get_ports core_done_0]
set_property IOSTANDARD LVCMOS12 [get_ports core_done_0]

set_property PACKAGE_PIN AM9 [get_ports core_done_1]
set_property IOSTANDARD LVCMOS12 [get_ports core_done_1]

set_property PACKAGE_PIN AM10 [get_ports core_done_2]
set_property IOSTANDARD LVCMOS12 [get_ports core_done_2]

set_property PACKAGE_PIN AM11 [get_ports core_done_3]
set_property IOSTANDARD LVCMOS12 [get_ports core_done_3]