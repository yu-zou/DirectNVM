...
-- Date        : Fri Feb 19 15:37:50 2021
-- Host        : yzou-PC running 64-bit Ubuntu 16.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /hdd/directnvm/rtl_proj/bd/design_1/ip/design_1_ref_clk_0_buf_0/design_1_ref_clk_0_buf_0_sim_netlist.vhdl
-- Design      : design_1_ref_clk_0_buf_0
...
entity design_1_ref_clk_0_buf_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_1_ref_clk_0_buf_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_1_ref_clk_0_buf_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_1_ref_clk_0_buf_0_util_ds_buf : entity is "ibufdsgte4";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_1_ref_clk_0_buf_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_1_ref_clk_0_buf_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ref_clk_0_buf_0_util_ds_buf : entity is "util_ds_buf";
end design_1_ref_clk_0_buf_0_util_ds_buf;

architecture STRUCTURE of design_1_ref_clk_0_buf_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ref_clk_0_buf_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of design_1_ref_clk_0_buf_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ref_clk_0_buf_0 : entity is "design_1_ref_clk_0_buf_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_ref_clk_0_buf_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_ref_clk_0_buf_0 : entity is "util_ds_buf,Vivado 2019.2";
end design_1_ref_clk_0_buf_0;

architecture STRUCTURE of design_1_ref_clk_0_buf_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_ref_clk_0_buf_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_ref_clk_0_buf_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.design_1_ref_clk_0_buf_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
