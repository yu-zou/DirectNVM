...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXI_ADDR_WIDTH {49} \
   ...
   CONFIG.C_SLOT_1_AXI_ADDR_WIDTH {49} \
   CONFIG.C_SLOT_1_AXI_ARUSER_WIDTH {16} \
   CONFIG.C_SLOT_1_AXI_AR_SEL {1} \
   CONFIG.C_SLOT_1_AXI_AWUSER_WIDTH {16} \
   ...
   CONFIG.C_SLOT_1_AXI_DATA_WIDTH {128} \
   CONFIG.C_SLOT_1_AXI_ID_WIDTH {20} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net net_slot_1_axi_ar_cnt [get_bd_pins g_inst/m_slot_1_axi_ar_cnt] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_1_axi_ar_ctrl [get_bd_pins ila_lib/probe66] [get_bd_pins slot_1_ar/dout]
  connect_bd_net -net net_slot_1_axi_araddr [get_bd_pins g_inst/m_slot_1_axi_araddr] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_1_axi_arburst [get_bd_pins g_inst/m_slot_1_axi_arburst] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_1_axi_arcache [get_bd_pins g_inst/m_slot_1_axi_arcache] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_1_axi_arid [get_bd_pins g_inst/m_slot_1_axi_arid] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_1_axi_arlen [get_bd_pins g_inst/m_slot_1_axi_arlen] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_1_axi_arlock [get_bd_pins g_inst/m_slot_1_axi_arlock] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_1_axi_arprot [get_bd_pins g_inst/m_slot_1_axi_arprot] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_1_axi_arqos [get_bd_pins g_inst/m_slot_1_axi_arqos] [get_bd_pins ila_lib/probe40]
  ...
  connect_bd_net -net net_slot_1_axi_aruser [get_bd_pins g_inst/m_slot_1_axi_aruser] [get_bd_pins ila_lib/probe42]
  ...
  connect_bd_net -net net_slot_1_axi_awuser [get_bd_pins g_inst/m_slot_1_axi_awuser] [get_bd_pins ila_lib/probe53]
